...
def _part_footprint(contours) -> Polygon | MultiPolygon | None:
    ...
    Each :class:`~meltio_platform.slicer.core.slicer.LayerContour` becomes an exterior ring with
...
def support_layer_footprints(
    ...
    Args:
        ...
        part_layers: The part's sliced :class:`~meltio_platform.slicer.core.slicer.Layer`
