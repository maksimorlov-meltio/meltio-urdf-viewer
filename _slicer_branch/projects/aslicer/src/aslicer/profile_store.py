"""Persistence for :class:`~aslicer.profile.MachineProfile` objects.
...
def factory_profiles() -> tuple[MachineProfile, ...]:
    ...
    Defined in code so they ship with every build and are always present and
    canonical, regardless of what is on disk. New factory presets are added here.
    """
