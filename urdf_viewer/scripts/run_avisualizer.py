...
URDF_URL = f"{APP_URL}/urdf"
DEFAULT_DEBUG_DATASET = "small-torture-test_1-0-0"
...
class AvisualizerLauncher(tk.Tk):
    def __init__(self) -> None:
        super().__init__()
        self.title("avisualizer service")
    ...
    def _build_ui(self) -> None:
        ...
        title = tk.Label(frame, text="avisualizer", font=("Segoe UI", 12, "bold"))
        title.pack(anchor="w")
        ...
        open_btn = tk.Button(button_row, text="Open UI", command=lambda: webbrowser.open(APP_URL))
        open_btn.pack(side="left")

        urdf_btn = tk.Button(button_row, text="Open URDF Viewer", command=lambda: webbrowser.open(URDF_URL))
        urdf_btn.pack(side="left", padx=(8, 0))
    ...
    def _start_backend(self) -> None:
        ...
        cmd = [
            ...
            "-m",
            "uvicorn",
            "avisualizer.web.app:create_app",
            "--factory",
            "--host",
            HOST,
            "--port",
    ...
    def _force_restart_on_port(self) -> bool:
        ...
        for pid in pids:
            ...
            is_owned_uvicorn = "uvicorn" in cmdline and "avisualizer.web.app:create_app" in cmdline
